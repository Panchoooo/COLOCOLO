...
class LaPolar(Store):
    ...
    def discover_entries_for_category(cls, category, extra_args=None):
        category_paths = [
            ...
            ['ropa-mujer', "Mujer", '', 1],
            ['zapatos-mujer', "Mujer", '', 1],
            ['ropa-interior-y-pijamas', "Mujer", '', 1],
            ['ropa-deportiva-mujer', "Mujer", '', 1],
            ['novedades-moda-mujer', "Mujer", '', 1],
            ['ropa-hombre', "Hombre",'',1 ],
            ['ropa-deportiva-hombre', "Hombre",'',1 ],
            ['zapatos-hombre', "Hombre",'',1 ],
            ['accesorios', "Hombre",'',1 ],
            ['bicicletas-y-scooters', "Deportes", "", 1],
            ['mundo-fitness', "Deportes", "", 1],
            ['zapatillas', "Deportes", "", 1],
            ['camping', "Deportes", "", 1],
            ['aire-libre', "Deportes", "", 1],
            ['accesorios-deportivos', "Deportes", "", 1],
            ['ropa-deportiva-mujer', "Deportes", "", 1],
            ['ropa-deportiva-hombre', "Deportes", "", 1],
            ['perfumes',  "Belleza", "", 1 ],
            ['maquillaje',  "Belleza", "", 1 ],
            ['cuidado-de-la-piel',  "Belleza", "", 1 ],
            ['cuidado-personal',  "Belleza", "", 1 ],
            ['cuidado-capilar',  "Belleza", "", 1 ],
            ['camas-europeas', "Dormitorio" , "", 1],
            ['camas-americanas', "Dormitorio" , "", 1],
            ['camas-funcionales', "Dormitorio" , "", 1],
            ['colchones', "Dormitorio" , "", 1],
            ['box-sprin', "Dormitorio" , "", 1],
            ['muebles-dormitorio', "Dormitorio" , "", 1],
            ['ropa-de-cama', "Dormitorio" , "", 1],
            ['descanso-infantil', "Dormitorio" , "", 1],
            ['muebles-dormitorio', "Muebles", "", 1],
            ['terraza', "Muebles", "", 1],
            ['organizadores', "Muebles", "", 1],
            ['comedor', "Muebles", "", 1],
            ['juegos-de-living', "Muebles", "", 1],
            ['sofas-seccionales', "Muebles", "", 1],
            ['sofas-y-sillones', "Muebles", "", 1],
            ['sofa-cama-i-futones', "Muebles", "", 1],
            ['sitiales', "Muebles", "", 1],
            ['pouf-y-banquetas', "Muebles", "", 1],
            ['mesas-de-living', "Muebles", "", 1],
            ['mesas-de-centro', "Muebles", "", 1],
            ['fundas-para-sillones', "Muebles", "", 1],
            ['menaje-cocina', "Hogar", "", 1],
            ['menaje-mesa', "Hogar", "", 1],
            ['parrillas', "Hogar", "", 1],
            ['alfombras', "Hogar", "", 1],
            ['decoracion', "Hogar", "", 1],
            ...
            ['coches', "Ninos", "", 1],
            ['sillas-de-auto', "Ninos", "", 1],
            ['descanso-infantil', "Ninos", "", 1],
            ['juguetes', "Ninos", "", 1],
            ['zapatillas', "Zapatos","",1],
            ['zapatos-mujer', "Zapatos","",1],
            ['zapatos-hombre', "Zapatos","",1],
            ['zapatos-ninos', "Zapatos","",1],
            ['super-combos', "Otras-lineas","",1],
            ['mascotas', "Otras-lineas","",1],
            ['otras-categorias', "Otras-lineas","",1],
            ['salud-y-bienestar', "Otras-lineas","",1],
            ['hogar-en-oferta', "outlet","",1],
            ['tecnologia-en-oferta', "outlet","",1],
            ['electrohogar-en-oferta', "outlet","",1],
            ['deporte-en-oferta', "outlet","",1],
            ['moda-mujer-en-oferta', "outlet","",1],
            ['moda-hombre-en-oferta', "outlet","",1],
            ['mundo-infantil-en-oferta', "outlet","",1],
            ['belleza-en-oferta', "outlet","",1],
            ['calzado-en-oferta', "outlet","",1],
        ]
